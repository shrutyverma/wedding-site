...
<div class="container" >
    ...
    <div class="row" >
        <div class="col-lg-8" style="margin-left:17%">
         ...
         <form id="contact-form" action="user_code.php" method="post" role="form" class="contactForm" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
						...
						<h5 style="text-align:left;color:white;font-weight:bold;font-size:12px">Gender</h5>
						<div id="gen" style="border:2px solid white">
						<input type="radio" name="a" value="male"/><b style="color:white;margin-right:20px;">Male</b>
                        <input type="radio" name="a" value="female"/><b style="color:white;">Female</b>
						</div>
						<div class="form-group">
                    ...
                    <div class="col-md-6">					    
                        <div class="form-group">
                            <label for="name" style="color:white;">
                                Address</label>
                            <textarea class="form-control" name="address" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Message" required ></textarea>
                            <div class="validation"></div>
                        </div>
                    </div>
					<label class="btn btn-default btn-file">
                        Upload pic <input type="file" name="file" style="display: none;">
                     </label>
                    <div class="col-md-12">
