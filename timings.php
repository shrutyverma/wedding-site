...
mysql_query("DELETE FROM timings WHERE id='$id'");
$sql="INSERT INTO timings(timings,id)VALUES ('$chkbox','$id')";
...
$resDapp = mysql_query("SELECT * FROM timings WHERE id='$id'");
...
?> />
       ...
       <tr>
         <th colspan="3" align="center"> <input type="text" name="appdate2" value="" />
           <input type="submit" name="settime" id="settime" value="Click Here to update timings" /></th>
       </tr>
     </table>
     </form>
     
     <a href="admin/adminzone.php"> < < Back </a><h2>&nbsp;</h2>
<div id="respond"></div>
    </div>
